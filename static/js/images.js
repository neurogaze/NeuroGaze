...
function updateTestDuration() {
  ...
  if (testSource === "/datacollect") {
    console.log("Test source is datacollect. Setting image test duration to 90 seconds.");
    return 90; // Set duration to 90 seconds for datacollect
  } else {
    console.log("Test source is not recognized. Setting image test duration to 30 seconds.");
